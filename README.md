# DIKit [![CI](https://github.com/andrewscwei/swift-dikit/workflows/CI/badge.svg?branch=master)](https://github.com/andrewscwei/swift-dikit/actions/workflows/ci.yml?query=branch%3Amain)
